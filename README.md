...
## 7. 결론 (Conclusion)
본 프로젝트는 복잡한 반도체 공정 데이터 내에 숨겨진 변수 간 상관관계를 규명하고, 불량 발생에 지배적인 영향을 미치는 핵심 인자를 특정했습니다. 이를 통해 **데이터 기반의 실시간 공정 모니터링 체계** 구축 가능성을 확인하였으며, 선행 품질 관리를 통한 **수율 손실(Yield Loss)** 최소화를 위한 통계적 근거를 제시했습니다.
